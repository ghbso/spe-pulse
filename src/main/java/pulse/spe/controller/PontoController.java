...
public class PontoController {
	...
	@Operation(summary = "Registra frequência do usuário", description = "Registra a batida de ponto do usuário", tags = {
			"Frequência" })
	@ApiResponses(value = {
	...
	@Operation(summary = "Retorna registros de frequência de um dado usuário em um dado dia", description = "Retorna a listagem com registros de frequência de um dado usuário em um dado dia ", tags = {
			"Frequência" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "operação realizada com sucesso"),
			@ApiResponse(responseCode = "401", description = "acesso não autorizado!"), 
	...
	@Operation(summary = "Retorna registros de frequência de um dado usuário no dia atual", description = "Retorna a listagem com registros de frequência de um dado usuário no dia atual ", tags = {
			"Frequência" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "operação realizada com sucesso"),
			@ApiResponse(responseCode = "401", description = "acesso não autorizado!"), 
	...
	@Operation(summary = "Retorna registros de frequência de um dado usuário em um dado intervalo", description = "Retorna a listagem com registros de frequência de um dado usuário em um dado intervalo ", tags = {
			"Frequência" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "operação realizada com sucesso"),
			@ApiResponse(responseCode = "401", description = "acesso não autorizado!"), 
	...
	@Operation(summary = "Retorna registros de frequência de um dado usuário no mês atual", description = "Retorna a listagem com registros de frequência de um dado usuário no mês atual ", tags = {
			"Frequência" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "operação realizada com sucesso"),
			@ApiResponse(responseCode = "401", description = "acesso não autorizado!"), 
	...
	@Operation(summary = "Retorna registros o total de ocorrências para cada usuário dentro de um intervalo", description = "Retorna a listagem com total de ocorrências de um cada usuário dentro de um intervalo ", tags = {
			"Frequência" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "operação realizada com sucesso"),
			@ApiResponse(responseCode = "401", description = "acesso não autorizado!"), 
	...
	@Operation(summary = "Retorna registros das ocorrências de um dado usuário dentro de um intervalo", description = "Retorna a listagem das ocorrências de um dado usuário dentro de um intervalo ", tags = {
			"Frequência" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "operação realizada com sucesso"),
			@ApiResponse(responseCode = "401", description = "acesso não autorizado!"), 
	...
	@Operation(summary = "Retorna relatório de ocorrências consolidade de um um intervalo", description = "Retorna a listagem de ocorrências consolidadas de um intervalo ", tags = {
			"Frequência" })
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "operação realizada com sucesso"),
			@ApiResponse(responseCode = "401", description = "acesso não autorizado!"), 
